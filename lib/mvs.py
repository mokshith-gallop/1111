    ...
    "properties": {
        ...
        "migration": {
            ...
            "properties": {
                ...
                "dataset_map": {"type": "object"},       # real dataset -> build dataset; remaps cross-dataset view refs
                "steps": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "dataset": {"type": "string"},   # build this step into THIS dataset (multi-dataset builds); else the default build dataset
                        },
                        "additionalProperties": True,
                    },
                },
